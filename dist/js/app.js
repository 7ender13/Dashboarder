...
.state("main.project", {
    url: "project/",
    templateUrl: 'pages/project/main.html'
})
.state("main.project.add", {
      url: "add",
      templateUrl: 'pages/project/add.html'
})
.state("main.project.get", {
    url: "get/:id",
    templateUrl: 'pages/project/get.html'
})
...
exports.default = {
  APP: "app",
  TITLE: "<div class='app-brand' style='text-align:center;'><img style='margin-bottom : 10px;width:70%;' src='assets/images/logo.png' alt=''><br/>Dashboarder</div>",
  PAGE: {
    "main.dashboard": {
      menu: "dashboard",
      title: "Dashboard",
